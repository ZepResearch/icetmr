...
function ExtraContentBelowTabs() {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-5xl mx-auto">
        ...
        <div className="relative">
          <div className="bg-white rounded-xl border p-6 h-full flex flex-col items-center text-center">
            <div className="h-16 w-16 rounded-full bg-gradient-to-t from-rose-400 to-orange-300 flex items-center justify-center mb-4">
        ...
        <div className="bg-gradient-to-r from-gray-100 to-gray-200 border rounded-3xl p-8 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center mb-6">
              <div className="h-10 w-10 rounded-full bg-gradient-to-t from-rose-400 to-orange-300 flex items-center justify-center mr-4">
  ...
  <div className="container mx-auto px-4">
    <div className="text-center mb-12">
      ...
      <div className="h-1 w-20 bg-gradient-to-t from-rose-400 to-orange-300 mx-auto mb-8 rounded-full"></div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
      <div className="relative bg-white rounded-3xl border overflow-hidden p-6 shadow-sm group hover:shadow-md transition-all">
        ...
        <div className="relative">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-t from-rose-400 to-orange-300 p-0.5 mb-4">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/submission">
                <Button className="bg-gradient-to-r from-rose-400 to-orange-300 text-white rounded-full">Submit Your Paper</Button>
              </Link>
              <Link href="/contact">
                <Button
                  variant="outline"
