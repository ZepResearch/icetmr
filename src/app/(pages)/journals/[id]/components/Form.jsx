...
export default function PaperSubmissionForm({ journalId, journalTitle }) {
  ...
  return (
    <Card className="shadow-lg border-0 overflow-hidden bg-slate-50">
      <div className="h-2  bg-gradient-to-l from-pink-500 via-red-500 to-yellow-500  "></div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 ">
          ...
          <CardFooter className="flex justify-end px-0 pt-4">
            <Button
              ...
              className="b bg-gradient-to-l from-pink-500 via-red-500 to-yellow-500   hover:scale-105 transition-all text-white w-full"
              size="lg"
            >
              {isSubmitting ? (
                <>
