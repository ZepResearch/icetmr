    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          {/* Page Header */}
          <div className="bg-gradient-to-bl from-pink-500 via-red-500 to-yellow-500 px-8 py-6">
          ...
          <div className="px-8 py-8 space-y-8">
            ...
            {/* Section 2 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">2. Scope of the Policy</h2>
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">3. Lodging a Complaint</h2>
              ...
              <div className="bg-orange-50 border-l-4 border-[#fcb346] p-4 rounded">
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">4. Complaint Review Process</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">5. Resolution and Outcomes</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* Section 6 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">6. Confidentiality</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">7. Appeals</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Section 8 */}
            <section>
              <h2 className="text-xl font-bold text-neutral-900 mb-4">8. Contact Information</h2>
              <p className="text-gray-700 leading-relaxed mb-4">For queries or complaints, please contact:</p>
              <div className="flex flex-col space-y-3">
                <div className="flex items-center space-x-3 text-orange-600">
                  <Mail className="w-5 h-5" />
                  <span>info@emergingtrendsconference.com</span>
                </div>
                <div className="flex items-center space-x-3 text-orange-600">
