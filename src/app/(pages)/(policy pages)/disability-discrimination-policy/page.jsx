      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                <p className="text-gray-700 text-sm">
                  <strong>Note:</strong> Participants requiring accommodations are encouraged to notify the Organizing Committee in advance via info@ICETMR.in to ensure timely arrangements.
                </p>
              </div>
            </section>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="text-center">
            ...
            <Link href={'/contact'}>
            <div className="inline-flex items-center space-x-2 bg-orange-100 text-orange-700 px-4 py-2 rounded-lg">
