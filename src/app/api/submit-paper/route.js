...
export async function POST(request) {
  try {
    ...
    const record = await pb.collection("ICETMR_paper_form_submission").create(pbFormData)
    ...
    await resend.emails.send({
      from: "Conference <info@emergingtrendsconference.com>",
      to: data.email,
      subject:
        "Paper Submission Confirmation - Emerging Trends Conference 2025",
    ...
    await resend.emails.send({
      ...
      subject: "New Paper Submission - Emerging Trends Conference 2025",
