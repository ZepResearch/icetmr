...
const adminEmail = process.env.ADMIN_EMAIL || "info@emergingtrendsconference.com"
...
export async function POST(request) {
  try {
    ...
    await resend.emails.send({
      from: "Emerging Trends Conf. <noreply@emergingtrendsconference.com>",
      to: email,
      subject: "Emerging Trends Conf. Registration Confirmation",
      html: userConfirmationTemplate(data),
    })

    // Send notification email to admin
    await resend.emails.send({
      from: "Emerging Trends Conf. Registration <noreply@emergingtrendsconference.com>",
      to: "info@emergingtrendsconference.com",
      subject: "New Emerging Trends Conf. Registration",
