...
export async function POST(req) {
  try {
    ...
    await resend.emails.send({
      from: process.env.FROM_EMAIL || "info@emergingtrendsconference.com",
      to: process.env.ADMIN_EMAIL || "info@emergingtrendsconference.com",
    ...
    await resend.emails.send({
      ...
      subject: "Payment Initiated for ICETMR Registration",
