...
export default function ConferenceFAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We have partnered with several hotels near the Bali International Convention Centre offering special conference rates. Options range from budget-friendly accommodations to luxury resorts. Book early as October is peak season in Bali. We recommend staying within 15km of the venue for easy transportation. Contact us at info@icetmr.org for hotel recommendations and booking assistance.",
    },
    {
