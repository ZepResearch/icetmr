...
function Organizer() {
    return (
        <section className="bg-gradient-to-r from-white to-slate-50 border-2 rounded-xl p-8 text-center shadow-lg max-w-screen-xl mx-auto my-8 px-2">
            <h2 className="text-5xl font-semibold mb-6 text-slate-900 ">
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 object-center'>
             <img
                src={st}
