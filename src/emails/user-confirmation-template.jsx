...
<head>
    ...
    <style>
        ...
        .registration-details {
            background: linear-gradient(135deg, rgba(236, 72, 153, 0.05) 0%, rgba(239, 68, 68, 0.05) 50%, rgba(234, 179, 8, 0.05) 100%);
        ...
        .conference-info {
            background: linear-gradient(135deg, rgba(236, 72, 153, 0.08) 0%, rgba(239, 68, 68, 0.08) 50%, rgba(234, 179, 8, 0.08) 100%);
            border-radius: 12px;
            padding: 25px;
            margin: 30px 0;
            text-align: center;
