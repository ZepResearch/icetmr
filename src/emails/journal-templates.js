export function getUserEmailTemplate(data) {
  ...
  <head>
    ...
    <style>
      ...
      .header {
        background: linear-gradient(to bottom left, #ec4899 0%, #ef4444 50%, #eab308 100%);
        color: white;
        padding: 40px 30px;
        text-align: center;
        position: relative;
      ...
      .info-box {
        background: linear-gradient(135deg, #fce7f3 0%, #fef2f2 50%, #fef3c7 100%);
      ...
      <div class="content">
        ...
        <div class="info-box">
          ...
          <ul class="info-list">
            ...
            <li>
              <span class="info-label">Research Track</span>
        ...
        <div class="contact-section">
          ...
          <p>📧 Email: <a href="mailto:info@emergingtrendsconference.com" style="color: #ec4899;">info@emergingtrendsconference.com</a><br>
          🌐 Website: <a href="https://emergingtrendsconference.com" style="color: #ec4899;">www.emergingtrendsconference.com</a></p>
        </div>
    ...
    <div class="email-container">
      ...
      <div class="content">
        ...
        <div class="details-section">
          ...
          <table class="details-table">
            <tr class="priority-row">
              <td class="field-label">Research Track</td>
            ...
            <tr>
              ...
              <td class="field-value">
                <a href="mailto:${data.email}" style="color: #ec4899; font-weight: 600;">${data.email}</a>
              </td>
            </tr>
            <tr>
        ...
        <div class="action-section">
          ...
          <p>• Review the submitted research paper for multidisciplinary research alignment</p>
          <p>• Assign to appropriate interdisciplinary review panel members</p>
